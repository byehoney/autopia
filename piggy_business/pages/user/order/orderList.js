...
Page({
    ...
    onLoad: function(e) { // 页面渲染完成
        ...
        var that = this;
        var currentTab = 'all', currentTabShop = 0;
        ...
        if(tuan_share_data){
          ...
          if (tuan_share_data.order_status<2){
            shareInfo = {
              ...
              desc: '小伙伴快来参团~',
              path: `/pages/details/index?tuan_id=${tuan_share_data.tuan_id}&share_uid=${getApp().globalData.my_uid}&shareType=2`,
            ...
            //已支付
              ...
              title: '邀请您参团~' + tuan_share_data.name,
              desc: '小伙伴快来参团~',
                path: '/pages/join/index?' + `tuan_id=${tuan_share_data.tuan_id}&team_id=${tuan_share_data.team_id}&item_id=${tuan_share_data.item_id}&type=1&share_uid=${getApp().globalData.my_uid}&shareType=2`,
                imageUrl: show_share_img == 1 ? (share_img) : (tuan_share_data.image || '')
            }
          }
        }else{
