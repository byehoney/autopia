...
Page({
    ...
    onLoad: function (e) {
        ...
        if (e.scene != undefined) { // 预览模式
            ...
            if (scene) {
                ...
                if(!e.friend && "undefined" != typeof scene_arr[2]){
                    e.friend = scene_arr[2];
                }
    ...
    onShareAppMessage: function () {
        ...
        var path = '/pages/bargain/details?id=' + that.data.id;
    ...
    playToo: function () {
        wx.navigateTo({
            url: '/pages/bargain/details?id=' + this.data.id
        })
    },
    gopay: function () {
        var that = this;
