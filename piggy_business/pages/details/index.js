...
Page({
    ...
    onReady: function () {
        ...
        let url = '/pages/details/index?tuan_id=' + this.data.tuan_id;
...
8          // result.err_msg.team_list = [...result.err_msg.team_list, ...result.err_msg.team_list, ...result.err_msg.team_list, ...result.err_msg.team_list]
    ...
    shopGO: function () { //跳转店铺活动页面
        ...
        // wx.redirectTo({ url: '/pages/details/shop?store_id=' + store_id });
        wx.redirectTo({ url: '/pages/index/index' })
    ...
    onShareAppMessage: function () {
      const { show_share_img, share_img } = app.globalData;
        return {
            ...
            path: '/pages/details/index?tuan_id=' + this.data.tuan_id + "&share_uid=" + getApp().globalData.my_uid + "&shareType=2",
