...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return getApp().shareGetFans(title, '', '/pages/presale/index', 1, imageUrl, `&id=${that.data.id}`);
    },
    getDetails: function () {
        var that = this;
        var data = {
