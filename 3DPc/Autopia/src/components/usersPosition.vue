    ...
    <div class="usersPosition1">
      ...
      <div class="rebounding" v-if="isShow1">
        ...
        <div :class="'upData'+i " v-for="(item,i) in upDatas" :key="i">
          ...
          <p>
            <animate-number :from="0" :to="item.number" duration="1000" easing="easeOutQuad" :formatter="formatter"></animate-number>
            <span v-if="i!=3">万+</span>
            <span v-else>万+**</span>
          </p>
        </div>
        <div class="bar">
        ...
        <p style="position:absolute;bottom:5%;color:#fff;left:3.2%">注：**700万+为最高数据</p>
      </div>
    ...
    data() {
      return {
        ...
        upDatas: [
          ...
          {title: "messages.rijunyueduliang", number: 5000},
          {title: "messages.DAU", number: 700},
        ],
